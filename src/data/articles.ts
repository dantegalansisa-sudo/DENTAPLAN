...
export const articles: Article[] = [
  {
    ...
    content: [
      ...
      'En DentaPlan evaluamos cada caso de forma personalizada. Durante tu consulta, analizaremos el estado de tus dientes, tus expectativas y tu presupuesto para recomendarte el tratamiento que mejor se adapte a ti.',
    ],
    tips: [
  ...
  },
  {
    ...
    readTime: '5 min',
    img: 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=500&q=80',
    content: [
      ...
      'En DentaPlan utilizamos tecnología de diagnóstico 3D para planificar cada implante con precisión milimétrica, asegurando los mejores resultados posibles para cada paciente.',
    ],
    tips: [
  ...
  },
  {
    ...
    readTime: '3 min',
    img: 'https://images.unsplash.com/photo-1571772996211-2f02c9727629?w=500&q=80',
    content: [
      ...
      'En DentaPlan creemos que la prevención es la mejor inversión en tu salud dental. Nuestro equipo está disponible para enseñarte las técnicas correctas y crear un plan de prevención personalizado.',
    ],
    tips: [
