...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    // Hero
    'hero.tagline': 'Odontología de Precisión',
    'hero.title1': 'TU',
    'hero.title2': 'SONRISA',
    ...
    // Footer
    'footer.tagline': 'Odontología de Precisión',
    'footer.rights': '© 2026 DentaPlan RD. Todos los derechos reservados.',
  ...
  en: {
    ...
    // Hero
    'hero.tagline': 'Precision Dentistry',
    'hero.title1': 'YOUR',
    'hero.title2': 'SMILE',
    ...
    // Footer
    'footer.tagline': 'Precision Dentistry',
    'footer.rights': '© 2026 DentaPlan RD. All rights reserved.',
