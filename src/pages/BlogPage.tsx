          ...
          <div className="bp__grid">
            ...
            >
              <div className="bp__cta-card">
                ...
                <a
                  href={`https://wa.me/18095620808?text=${encodeURIComponent(`Hola, leí el artículo "${article.title}" y me gustaría agendar una consulta.`)}`}
                  target="_blank"
                ...
                <a href="tel:+18095620808" className="bp__cta-phone">
                  O llámanos: (809) 562-0808
                </a>
              </div>
