...
const infoItems = [
  { icon: '📍', label: 'Dirección', value: 'Galería 360, 1er Nivel, Santo Domingo' },
  { icon: '📞', label: 'Teléfono', value: '(809) 562-0808' },
  { icon: '⏰', label: 'Horario', value: 'Lun - Vie: 8:00 AM - 6:00 PM | Sáb: 9:00 AM - 2:00 PM' },
  { icon: '💬', label: 'WhatsApp', value: '(809) 562-0808' },
  { icon: '✉️', label: 'Email', value: 'info@dentaplanrd.com' },
];
    ...
    <div className="booking-cal__root">
      ...
      {selectedDay && selectedTime && (
        <motion.button
          ...
          onClick={() =>
            window.open(
              `https://wa.me/18095620808?text=Hola, quiero agendar una cita el ${selectedDay} de ${MONTH_NAMES[month]} a las ${selectedTime}.`,
              '_blank',
            )
          }
        >
...
export default function BookingSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    window.open(`https://wa.me/18095620808?text=${text}`, '_blank');
    setSent(true);
