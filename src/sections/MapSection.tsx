        ...
        >
          <div className="map-section__info">
            <div className="map-section__detail">
              ...
              <span className="map-section__detail-value">Galería 360, 1er Nivel</span>
            ...
            <div className="map-section__detail">
              ...
              <a href="tel:+18095620808" className="map-section__detail-value map-section__link">(809) 562-0808</a>
              <a href="mailto:info@dentaplanrd.com" className="map-section__detail-value map-section__link">info@dentaplanrd.com</a>
            </div>
          </div>
